...
const RollingRestart = () => {
    return (
        <div style={{width: '36em', maxWidth: '100%'}}>
            ...
            <p>The kafka-rolling-restart script can be used to safely restart an entire cluster, one server at a time.
                The script finds all the servers in a cluster, checks their health status and executes the restart.</p>
