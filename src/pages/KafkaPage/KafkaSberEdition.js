...
const KafkaSberEdition = () => {
    return (
        <div style={{maxWidth: '100%', paddingRight: '1em'}}>
            ...
            <p>Но как бы то ни было, при длительном пребывании человека в космосе желательно создать для него привычную,
                похожую на земную обстановку, мир, в котором есть и верх и низ. И не случайно, что идея создания
                искусственной тяжести зародилась почти одновременно с самыми первыми трудами об освоении космоса.</p>

            <p>Силу земного притяжения может заменить центробежная сила, ибо по биологическому действию инерциальные и
                гравитационные силы не отличаются друг от друга.</p>

            <p>Величина центробежной силы зависит от скорости вращения и радиуса. Исходя из этого, можно подумать, что
                идеальной формой для космического объекта было бы тело, имеющее форму тора — «бублика».</p>

            <p>Подробнее см.: https://www.nkj.ru/archive/articles/28636/ (Наука и жизнь, Мечты инженеров. Архитектура в
                космосе)</p>
        </div>
    )
}
